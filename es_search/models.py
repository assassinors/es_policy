...
class SearchRecord(models.Model):
    ...
    remote_port = models.CharField(db_column='REMOTE_PORT', max_length=100, blank=True, null=True)  # Field name made lowercase.
    ...
    search_date = models.CharField(db_column='SEARCH_DATE', max_length=100, blank=True, null=True)  # Field name made lowercase.
    search_time = models.CharField(db_column='SEARCH_TIME', max_length=100, blank=True, null=True)  # Field name made lowercase.
...
class SearchDetailRecord(models.Model):
    ...
    user_name = models.CharField(db_column='USER_NAME', max_length=100, blank=True, null=True)  # Field name made lowercase.
    search_detail_time = models.DateTimeField(db_column='SEARCH_DETAIL_TIME', blank=True, null=True)  # Field name made lowercase.
    search_detail_stamp = models.DecimalField(db_column='SEARCH_DETAIL_STAMP', max_digits=65, decimal_places=30, blank=True, null=True)
  # Field name made lowercase.
    anchor = models.CharField(db_column='ANCHOR', max_length=100, blank=True, null=True)  # Field name made lowercase.
    source_id = models.CharField(db_column='SOURCE_ID', max_length=200, blank=True, null=True)  # Field name made lowercase.
    session_id = models.CharField(db_column='SESSION_ID', max_length=200, blank=True, null=True)  # Field name made lowercase.
    item_unique_coding = models.CharField(db_column='ITEM_UNIQUE_CODING', max_length=200, blank=True, null=True)
    user_ip_area = models.CharField(db_column='USER_IP_AREA', max_length=255, blank=True, null=True)  # Field name made lowercase.
